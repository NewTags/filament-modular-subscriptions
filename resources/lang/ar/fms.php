...
return [
    'resources' => [
        'plan' => [
            ...
            'hints' => [
                ...
                'is_pay_as_you_go' => 'إذا تم تمكين هذا الخيار، فإن هذه الخطة م��صصة للدفع حسب الاستخدام وسيتم إصدار فواتير عليها بناءً على الاستخدام الفعلي للوحدات المستخدمة عند نهاية الفترة المحددة',
            ],
            'placeholders' => [
        ...
        'invoice' => [
            ...
            'payment_pending' => 'تم إرسال الفاتورة ب��جاح. في انتظار التأكيد من الجهة المختصة',
        ],
        'payment' => [
            'name' => 'المدفوعات',
            'singular_name' => 'الدفع',
    ...
    'tenant_subscription' => [
        ...
        'switch_to_plan' => 'تغيير إل�� هذه الخطة',
    ...
    'payment' => [
        ...
        'select_method_description' => 'ا��تر طريقة الدفع المفضلة لإتمام المعاملة.',
        'method' => 'طريقة الدفع',
        ...
        'online_coming_soon' => 'الدفع الإل��تروني سيكون متاحاً قريباً!',
        'online_not_available' => 'الدفع الإلكتروني غير متاح حالياً',
        'receipt_help_text' => 'يرجى رفع صورة إيصال التحويل البنكي',
    ],
    'file_entry' => [
    ...
    'logs' => [
        ...
        'module_limit_reached' => '��م الوصول إلى الحد الأقصى لاستخدام وحدة :module',
        ...
        'events' => [
            ...
            'subscription_expired' => 'ا��تهاء اشتراك',
        ],
    ],
    'details' => 'التفاصيل',
    'statuses' => [
    ...
    'notifications' => [
        'subscription' => [
            ...
            'payg_started' => [
                'title' => 'مرحباً ب��! تم تفعيل اشتراكك بنجاح',
        ...
        'admin_message' => [
            ...
            'suspended' => [
                'title' => '[إدارة النظا��] تعليق اشتراك',
