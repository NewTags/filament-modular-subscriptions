...
return [
    'resources' => [
        'plan' => [
            ...
            'hints' => [
                ...
                'is_pay_as_you_go' => 'إذا تم تمكين هذا الخيار، فإن هذه الخطة مخ��صة للدفع حسب الاستخدام وسيتم إصدار فواتير عليها بناءً على الاستخدام الفعلي للوحدات المستخدمة عند نهاية الفترة المحددة',
            ],
            'placeholders' => [
        ...
        'invoice' => [
            ...
            'payment_pending' => 'تم إرسال الفاتورة بن��اح. في انتظار التأكيد من الجهة المختصة',
        ],
        'payment' => [
            'name' => 'المدفوعات',
            'singular_name' => 'الدفع',
    ...
    'tenant_subscription' => [
        ...
        'plan_switched_successfully' => 'تم تغيير ا��خطة بنجاح',
        ...
        'benefit_2_description' => 'حماية وموثوقية على مستوى المؤ��سات مدمجة في كل خطة اشتراك.',
        ...
        'no_minimum_commitment' => 'لا يوجد حد أدنى للالتزام',
        'usage_tracked_realtime' => 'يتم تتبع الاستخدام في الوقت الفعلي',
        'pay_as_you_go' => 'ال��فع حسب الاستخدام',
        'subscription' => 'اشتراك',
        'per_unit' => 'لكل وحدة',
        'only_pay_for_what_you_use' => 'ادفع فقط مقابل ما تستخدمه',
        'included_features' => 'الميزات المضمنة',
    ...
    'invoice' => [
        ...
        'total_with_tax' => 'الإجمالي مع ال��ريبة',
        'currency' => 'ريال سعودي',
    ],
    'payment' => [
    ...
    'notifications' => [
        'subscription' => [
            ...
            'subscription_switched' => [
                ...
                'body' => 'تم تحديث اشتراكك في :tenant إلى خطة :plan. استم��ع بالمميزات الجديدة حتى :end_date. نتمنى لك تجربة رائعة!',
            ],
            ...
            'payment_rejected' => [
                ...
                'body' => 'للأسف، تم رفض دفعتك بقيمة :amount :currency. السبب: :reason. يرجى المحاولة مرة أخرى أو التواصل مع الدعم للمساع��ة',
            ],
            'invoice_generated' => [
        ...
        'admin_message' => [
            ...
            'subscription_grace_period' => [
                'title' => '[��دارة النظام] اشتراك في فترة السماح',
