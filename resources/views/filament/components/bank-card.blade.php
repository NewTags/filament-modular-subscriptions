    ...
    <div class="bank-card-inner">
        ...
        <div class="bank-card-content">
            ...
            <div class="bank-card-grid">
                <div class="bank-card-field">
                    <p class="bank-card-label">{{ __('filament-modular-subscriptions::fms.resources.payment.iban') }}</p>
                    <p class="bank-card-value mono">{{ $iban }}</p>
                </div>

                <div class="bank-card-field">
                    <p class="bank-card-label">{{ __('filament-modular-subscriptions::fms.resources.payment.swift') }}</p>
